...
/*- Copy both files in your src/<your_package> folder

- To run it right click on AutocompleteGUI.java  -> Run AS -> Run Configurations...

-On the next windows select the Arguments tab

- In the "program arguments" box enter: the path to pokemon.txt and a number representing the maximum number of suggestions you want to display
*/
    ...
    extends JFrame
{
        ...
        extends JPanel
    {
        ...
        public AutocompletePanel(String filename)
        {
            ...
            // if (line == null) {
            // System.err.println("Could not read line " + (i+1) + " of " +
            // filename);
            // System.exit(1);
            // }
